# Foreseeable Problems in OpenClaw’s GitHub Actions Minutes Execution Path
...
Every new comment triggers full workflow execution (`.github/workflows/GITOPENCLAW-WORKFLOW-AGENT.yml:3-8`). This includes short acknowledgments or iterative “small nudge” comments that might not need full agent runs.
