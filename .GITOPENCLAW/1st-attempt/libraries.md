...
Generated on 2026-03-01 from manifest files. This lists direct external dependencies; internal package opennipper is intentionally excluded.
...
| `@aws-sdk/client-bedrock`                    | `^3.998.0`             | core gateway/CLI                                                       | AWS Bedrock API client for model access.                              |
| `@buape/carbon`                              | `0.0.0-beta-20260216184201` | core gateway/CLI                                                       | Code-to-image rendering helper (Carbon-style output).                 |
| `@clack/prompts`                             | `^1.0.1`               | core gateway/CLI                                                       | Interactive terminal prompt components for CLI flows.                 |
| `@discordjs/opus`                            | `^0.10.0`              | core gateway/CLI                                                       | Native Opus audio codec bindings (optional dependency).               |
| `@discordjs/voice`                           | `^0.19.0`              | core gateway/CLI                                                       | Discord voice connection support.                                     |
...
| `@larksuiteoapi/node-sdk`                    | `^1.59.0`              | core gateway/CLI, feishu extension                                     | Feishu/Lark OpenAPI SDK for channel integration.                      |
...
| `@mariozechner/pi-agent-core`                | `0.55.1`               | core gateway/CLI                                                       | Core runtime for Pi agent orchestration.                              |
| `@mariozechner/pi-ai`                        | `0.55.1`               | core gateway/CLI                                                       | Model/tool abstraction layer used by the gateway.                     |
| `@mariozechner/pi-coding-agent`              | `0.55.1`               | core gateway/CLI                                                       | Coding-agent runtime utilities.                                       |
| `@mariozechner/pi-tui`                       | `0.55.1`               | core gateway/CLI                                                       | Terminal UI primitives used by CLI/agent UX.                          |
| `@matrix-org/matrix-sdk-crypto-nodejs`       | `^0.4.0`               | matrix extension                                                       | Matrix end-to-end encryption support.                                 |
| `@microsoft/agents-hosting`                  | `^1.3.1`               | msteams extension                                                      | Microsoft Agents hosting primitives for Teams integration.            |
...
| `@opentelemetry/api-logs`                    | `^0.212.0`             | diagnostics-otel extension                                             | OpenTelemetry log API support.                                        |
| `@opentelemetry/exporter-logs-otlp-proto`    | `^0.212.0`             | diagnostics-otel extension                                             | OTLP/Proto log exporter.                                              |
| `@opentelemetry/exporter-metrics-otlp-proto` | `^0.212.0`             | diagnostics-otel extension                                             | OTLP/Proto metrics exporter.                                          |
| `@opentelemetry/exporter-trace-otlp-proto`   | `^0.212.0`             | diagnostics-otel extension                                             | OTLP/Proto trace exporter.                                            |
| `@opentelemetry/resources`                   | `^2.5.1`               | diagnostics-otel extension                                             | Resource attributes for telemetry metadata.                           |
| `@opentelemetry/sdk-logs`                    | `^0.212.0`             | diagnostics-otel extension                                             | OpenTelemetry log SDK implementation.                                 |
| `@opentelemetry/sdk-metrics`                 | `^2.5.1`               | diagnostics-otel extension                                             | OpenTelemetry metrics SDK implementation.                             |
| `@opentelemetry/sdk-node`                    | `^0.212.0`             | diagnostics-otel extension                                             | Node.js OpenTelemetry SDK bootstrap.                                  |
| `@opentelemetry/sdk-trace-base`              | `^2.5.1`               | diagnostics-otel extension                                             | OpenTelemetry tracing SDK primitives.                                 |
...
| `@snazzah/davey`                             | `^0.1.9`               | core gateway/CLI                                                       | DAVE protocol implementation for Discord voice encryption.            |
| `@slack/bolt`                                | `^4.6.0`               | core gateway/CLI                                                       | Slack app framework and event handling.                               |
| `@slack/web-api`                             | `^7.14.1`              | core gateway/CLI                                                       | Slack Web API client.                                                 |
...
| `@types/node`                                | `^25.3.1`              | core gateway/CLI                                                       | Development/test dependency for core gateway/CLI.                     |
...
| `@typescript/native-preview`                 | `7.0.0-dev.20260225.1` | core gateway/CLI                                                       | Development/test dependency for core gateway/CLI.                     |
...
| `acpx`                                       | `^0.1.13`              | acpx extension                                                         | Agent Client Protocol extension runtime.                              |
| `ajv`                                        | `^8.18.0`              | core gateway/CLI                                                       | JSON Schema validator used by core and vendored components.           |
...
| `discord-api-types`                          | `^0.38.40`             | core gateway/CLI                                                       | Discord API type definitions.                                         |
| `dompurify`                                  | `^3.3.1`               | web control UI                                                         | HTML sanitization for UI rendering.                                   |
| `dotenv`                                     | `^17.3.1`              | core gateway/CLI                                                       | Environment variable loading from .env files.                         |
...
| `gaxios`                                     | `7.1.2`                | core gateway/CLI                                                       | Google HTTP request client library.                                   |
| `google-auth-library`                        | `10.5.0, ^10.6.1`      | core gateway/CLI, googlechat extension                                 | Google OAuth/service-account auth client.                             |
| `grammy`                                     | `^1.40.1`              | core gateway/CLI                                                       | Telegram bot framework.                                               |
| `https-proxy-agent`                          | `^7.0.6`               | core gateway/CLI, feishu extension                                     | HTTP/HTTPS proxy agent for outbound requests.                         |
| `ipaddr.js`                                  | `^2.3.0`               | core gateway/CLI                                                       | IP address parsing and validation utilities.                          |
...
| `markdown-it`                                | `^14.1.1, 14.1.1`      | core gateway/CLI, matrix extension                                     | Markdown parser with plugin ecosystem.                                |
| `marked`                                     | `^17.0.3`              | web control UI                                                         | Markdown parser/renderer for UI surfaces.                             |
| `music-metadata`                             | `^11.12.1`             | matrix extension                                                       | Audio metadata parsing.                                               |
| `node-domexception`                          | `npm:@nolyfill/domexception@^1.0.28` | core gateway/CLI                                                       | DOMException polyfill for Node.js compatibility.                      |
| `node-edge-tts`                              | `^1.2.10`              | core gateway/CLI                                                       | Microsoft Edge text-to-speech integration.                            |
| `node-llama-cpp`                             | `3.16.2`               | core gateway/CLI                                                       | Local llama.cpp model runtime (peer integration).                     |
| `nostr-tools`                                | `^2.23.1`              | nostr extension                                                        | Nostr protocol cryptography and message tooling.                      |
| `openai`                                     | `^6.25.0`              | memory-lancedb extension                                               | Runtime dependency for memory-lancedb extension.                      |
| `opusscript`                                 | `^0.1.1`               | core gateway/CLI                                                       | Pure JS Opus audio codec for Discord voice.                           |
| `osc-progress`                               | `^0.3.0`               | core gateway/CLI                                                       | CLI progress bars/spinners.                                           |
| `oxfmt`                                      | `0.35.0`               | core gateway/CLI                                                       | Oxc-based code formatter.                                             |
| `oxlint`                                     | `^1.50.0`              | core gateway/CLI                                                       | Oxc-based linter.                                                     |
| `oxlint-tsgolint`                            | `^0.15.0`              | core gateway/CLI                                                       | TypeScript-focused lint rules for Oxlint.                             |
...
| `signal-polyfill`                            | `^0.2.2`               | web control UI                                                         | TC39 Signals proposal polyfill for reactive state.                    |
| `signal-utils`                               | `0.21.1, ^0.21.1`      | core gateway/CLI, web control UI                                       | Signal protocol utility helpers.                                      |
| `sqlite-vec`                                 | `0.1.7-alpha.2`        | core gateway/CLI                                                       | Vector extension bindings for SQLite.                                 |
| `tar`                                        | `7.5.9`                | core gateway/CLI                                                       | TAR archive creation/extraction.                                      |
...
| `undici`                                     | `^7.22.0, 7.22.0`      | core gateway/CLI, zalo extension                                       | HTTP/1.1 client and fetch implementation.                             |
...
| `zod`                                        | `^4.3.6`               | core gateway/CLI, feishu extension, matrix extension (+4 more)         | Type-safe runtime schema validation.                                  |
...
| `sparkle`                  | `2.9.0`       | https://github.com/sparkle-project/Sparkle              | In-app macOS update framework.                                |
...
| `swift-log`                | `1.10.1`      | https://github.com/apple/swift-log.git                  | Logging API implementation for Swift services/apps.           |
...
| `androidx.compose:compose-bom:2026.02.00`                 | `androidTestImplementation, implementation` | Compose Bill of Materials to align Compose package versions.    |
...
| `androidx.navigation:navigation-compose:2.9.7`            | `implementation`                            | Navigation stack/routing for Compose UI.                        |
...
| `com.journeyapps:zxing-android-embedded:4.3.0`            | `implementation`                            | QR code scanning via ZXing embedded library.                    |
| `com.squareup.okhttp3:mockwebserver:5.3.2`                | `testImplementation`                        | Mock HTTP server for OkHttp integration tests.                  |
...
| `io.kotest:kotest-assertions-core-jvm:6.1.3`              | `testImplementation`                        | Kotest assertion library.                                       |
| `io.kotest:kotest-runner-junit5-jvm:6.1.3`                | `testImplementation`                        | Kotest test runner on JUnit 5 platform.                         |
| `junit:junit:4.13.2`                                      | `testImplementation`                        | JUnit test framework (JUnit 4 API).                             |
| `org.bouncycastle:bcprov-jdk18on:1.83`                    | `implementation`                            | BouncyCastle cryptography provider.                             |
| `org.commonmark:commonmark:0.27.1`                        | `implementation`                            | CommonMark Markdown parser.                                     |
| `org.commonmark:commonmark-ext-autolink:0.27.1`           | `implementation`                            | CommonMark autolink extension.                                  |
| `org.commonmark:commonmark-ext-gfm-strikethrough:0.27.1`  | `implementation`                            | CommonMark GFM strikethrough extension.                         |
| `org.commonmark:commonmark-ext-gfm-tables:0.27.1`         | `implementation`                            | CommonMark GFM tables extension.                                |
| `org.commonmark:commonmark-ext-task-list-items:0.27.1`    | `implementation`                            | CommonMark task list items extension.                           |
...
| `org.jetbrains.kotlinx:kotlinx-serialization-json:1.10.0` | `implementation`                            | Kotlin JSON serialization implementation.                       |
| `org.junit.vintage:junit-vintage-engine:6.0.2`            | `testRuntimeOnly`                           | Runs JUnit 3/4 tests on the JUnit Platform.                     |
| `org.robolectric:robolectric:4.16.1`                      | `testImplementation`                        | JVM-based Android runtime for unit tests.                       |

### Android Build Plugins

| Plugin ID                                   | Version  | Purpose                                                 |
| ------------------------------------------- | -------- | ------------------------------------------------------- |
| `com.android.application`                   | `9.0.1`  | Android Gradle plugin for building application modules. |
...
| `golang.org/x/net`              | `0.50.0` | Supplemental Go networking packages.                |
